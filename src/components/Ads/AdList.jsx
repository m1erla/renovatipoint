            ...
            {filteredAds.length === 0 ? (
              ...
              >
                ...
                <p className="text-muted-foreground dark:text-gray-400 text-center mb-6 max-w-md">
                  Arama kriterlerinize uygun ilan bulunamadı. Farklı anahtar
                  kelimeler deneyebilir veya filtreleri değiştirebilirsiniz.
                </p>
              </motion.div>
            ) : (
              <motion.div
                        ...
                        {isAuthenticated ? (
                          isExpert ? (
                            ...
                            <div className="text-center">
                              ...
                              <p className="text-xs text-muted-foreground dark:text-gray-400 mt-2 flex items-center justify-center gap-1">
                                ...
                                Not: Sadece uzman hesapları başvuru yapabilir
                              </p>
                            </div>
                          )
                        ) : (
                          <div className="text-center">
                            ...
                            <p className="text-xs text-muted-foreground dark:text-gray-400 mt-2 flex items-center justify-center gap-1">
                              ...
                              İlanlara başvurmak için giriş yapmalısınız
                            </p>
                          </div>
                        )}
                      </div>
